...
#include "buffer.h"
#include "buffer_fwd.h"        // add by simon
...
#include "ceph_frag.h"
// #include "include/assert.h" // remove by simon
#include <set>                 // add by simon
#include <iostream>            // add by simon
/*
 * 
...
public:
  ...
  //  bool force_to_leaf(CephContext *cct, frag_t x) {  // change by simon
